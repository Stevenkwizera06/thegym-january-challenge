...
function Program() {
  return (
    <Wrapper>
      <div className="flex sm:flex-col  bg-white px-32 sm:px-1  mx-auto   space-x-6">
        <div></div>
        {/* 1 card */}
        <div className="mt-8 sm:w-[450px]">
          <div>
            <Image className="sm:w-[300px]" src={digital} alt="drive" />
          </div>
          <div className="space-y-4">
            <p className="font-bold text-2xl mt-2">Digital services</p>
            <div className="flex hover:underline">
              <Image className="" src={rightChevron} alt="drive" />
              <p className="text-blue-700 text-xl"> Getting started</p>
            </div>
            <div className="flex hover:underline">
              <Image className="" src={rightChevron} alt="drive" />
              <p className="text-blue-700 text-xl"> Getting started</p>
